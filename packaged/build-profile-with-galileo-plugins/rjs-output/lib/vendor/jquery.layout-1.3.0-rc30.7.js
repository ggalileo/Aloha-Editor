...
,	revision:	0.033007 // 1.3.0 final = 1.0300 - major(n+).minor(nn)+patch(nn+)
	...
	// can update code here if Aloha.browser is phased out or logic changes
,	browser: {
	...
	,	boxModel:	Aloha.support.boxModel !== false || !Aloha.browser.msie // ONLY IE reverts to old box-model - update for older jQ onReady
